...
SELECT film FROM movies GROUP BY film ORDER BY count(film)DESC LIMIT 2;
-- SELECT film, count(film) FROM movies GROUP BY film ORDER BY count(film)DESC LIMIT 2; -- with the count